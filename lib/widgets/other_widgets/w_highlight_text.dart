...
class HighlightedText extends StatelessWidget {
  const HighlightedText({
    ...
    this.textStyle = const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600),
    this.textStyleHighlight = const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600),
