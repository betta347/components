...
class WCupertinoSwitch extends StatefulWidget {
  ...
  final Color inActiveBorderColorColor;
  final Color animatedCircleActiveColor;
  final Color animatedCircleInActiveColor;
  final double height;
  final double width;
  ...
  const WCupertinoSwitch({
    ...
    this.inActiveBorderColorColor = Colors.white,
            ...
            children: [
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                      color: isSwitched ? widget.activeBorderColor : widget.inActiveBorderColorColor,
                      width: 1,
              ...
              AnimatedPositioned(
                ...
                right: isClicked && isSwitched
                    ...
                    : isClicked && !isSwitched
                        ...
                        : isSwitched
                            ? 2
                            : widget.width - (widget.height - 5) - widget.padding,
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isSwitched ? widget.animatedCircleActiveColor : widget.animatedCircleInActiveColor,
                  ),
                ),
              )
            ],
